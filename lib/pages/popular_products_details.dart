...
import 'package:shop/countrollers/cart_controller.dart';
import 'package:shop/countrollers/popular_product_controller.dart';
import 'package:shop/utilities/app_icons.dart';
...
// .select('name')
    .select();
class PopularProductsDetails extends StatelessWidget {
            ...
            Container(
              ...
              child: Stack(
                  children: [
                    ...
                    hotItemText.toString() == 'null'
                        ? Container()
                        : Positioned(
                      left: 0,
                      top: Dimensions.popularProductImageHeight -
                          Dimensions.height30,
                      child: Container(
                        height: Dimensions.height30,
                        //width: double.infinity,
                        decoration: BoxDecoration(
                          color: AppColors.instaCartPurple,
                          borderRadius: BorderRadius.only(topRight: Radius
                              .circular(Dimensions.height10 / 2)),
                        ),
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: GoogleFonts.ubuntu(
                                color: AppColors.onInstaCartPurple,
                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        hotItem == false ? Container() : AutoSizeText(
                          '  ${(((priceBefore! / price) - 1) *
                              100).toStringAsFixed(0)}%  Discount',
                          overflow: TextOverflow.fade,
                          maxLines: 1,
                          style: GoogleFonts.kanit(
                            color: Theme
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.only(
                        bottom: Dimensions.height10, right: Dimensions.width10),
                    child: Row(
                      children: [
                        Container(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Provider.of<PopularProductController>(context, listen: false).incrementCounter(false);
                      },
                      child: AppIcons(
                    ...
                    Consumer<PopularProductController>(
                      builder: (context, popular, child){
                      return Text(popular.counter.toString(),
                    ...
                    GestureDetector(
                      onTap: () {
                        Provider.of<PopularProductController>(context, listen: false).incrementCounter(true);
                      },
                      child: AppIcons(
